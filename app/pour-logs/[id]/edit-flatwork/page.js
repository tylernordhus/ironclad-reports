  ...
  return (
    <main style={{ maxWidth: '680px', margin: '0 auto', padding: '1.5rem' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
        <h1 style={{ color: '#1a1a1a', fontSize: '1.8rem', marginBottom: '.5rem' }}>Edit Flatwork Pour Log</h1>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={sectionStyle}>
          ...
          <div style={fieldStyle}>
            ...
            <input name="area_location" style={inputStyle} defaultValue={log.area_location || ''} />
          </div>
          <div style={rowStyle}>
            <div style={{ flex: 1 }}>
              <label style={labelStyle}>Square Footage</label>
              <input name="square_footage" style={inputStyle} defaultValue={log.square_footage || ''} />
            </div>
            <div style={{ flex: 1 }}>
              <label style={labelStyle}>Thickness (in)</label>
              <input name="thickness" style={inputStyle} defaultValue={log.thickness || ''} />
            </div>
          </div>
          <div style={rowStyle}>
            <div style={{ flex: 1 }}>
              <label style={labelStyle}>Total Est. Yards</label>
              <input name="total_yards" style={inputStyle} defaultValue={log.total_yards || ''} />
            </div>
            <div style={{ flex: 1 }}>
              <label style={labelStyle}>Finish Type</label>
              <select name="finish_type" style={inputStyle} defaultValue={log.finish_type || ''}>
          ...
          <div style={fieldStyle}>
            ...
            <textarea name="general_notes" rows={3} style={{ ...inputStyle, resize: 'vertical' }} defaultValue={log.general_notes || ''} />
          </div>
        </div>
